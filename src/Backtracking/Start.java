...
public class Start {
	...
	Start() throws IOException {
		...
		main_gui.add(queen_image_label, setGridBagConstraints(-1, 0));
		main_gui.add(queen_number_text_field, setGridBagConstraints(-2, 0));
		main_gui.add(hillclimb_button, setGridBagConstraints(-1, 1));
		main_gui.add(start_button, setGridBagConstraints(-2, 1));
		main_gui.add(genetic_button, setGridBagConstraints(-3, 1));
		main_gui.add(exit_button, setGridBagConstraints(-3, 3));
